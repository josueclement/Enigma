...
public interface IHashServiceFactory
{
    ...
    IHashService CreateMd5Service(int bufferSize);
    
    /// <summary>
    /// Create a hash service with SHA1 digest
    /// </summary>
    /// <param name="bufferSize">Buffer size</param>
    IHashService CreateSha1Service(int bufferSize);
    ...
    /// <param name="bufferSize">Buffer size</param>
    IHashService CreateSha3Service(int bitLength, int bufferSize);
    
    /// <summary>
    /// Create a hash service with SHA256 digest
    /// </summary>
    /// <param name="bufferSize">Buffer size</param>
    IHashService CreateSha256Service(int bufferSize);
    
    /// <summary>
    /// Create a hash service with SHA512 digest
    /// </summary>
    /// <param name="bufferSize">Buffer size</param>
    IHashService CreateSha512Service(int bufferSize);
}